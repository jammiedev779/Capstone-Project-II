...
<?php endif; ?>
                    ...
                    <?php if((! \Filament\Support\is_slot_empty($footer)) || (is_array($footerActions) && count($footerActions)) || (! is_array($footerActions) && (! \Filament\Support\is_slot_empty($footerActions)))): ?>
                        <div
                            class="<?php echo \Illuminate\Support\Arr::toCssClasses([
...
<?php /**PATH C:\Users\johnk\Capstone-Project-II\Backend\vendor\filament\support\resources\views\components\modal\index.blade.php ENDPATH**/ ?>