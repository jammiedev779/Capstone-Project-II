                            ...
                            <td colspan="5" class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 bg-gray-50">
                                <div class="p-4 bg-white rounded shadow-md w-full">
                                    <div class="mb-4">
                                        ...
                                        <p class="text-sm text-gray-700"><?php echo e($history->note); ?></p>
                                    </div>
                                    <table class="min-w-full divide-y divide-gray-200 w-full">
                                        <thead class="bg-gray-50">
                                            <tr>
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $history->prescription; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prescription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 w-1/12"><?php echo e($prescription->medicine_name); ?></td>
                                                    <td class="px-6 py-4 whitespace-normal text-sm text-gray-900 w-7/12"><?php echo e($prescription->description); ?></td>
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 w-1/12"><?php echo e($prescription->duration); ?></td>
                                                </tr>
