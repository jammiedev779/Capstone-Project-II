        ...
        <?php if(count($containers)): ?>
            ...
            >
                ...
                <?php $__currentLoopData = $containers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uuid => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    >
                        <?php if($reorderActionIsVisible || $moveUpActionIsVisible || $moveDownActionIsVisible || $hasBlockLabels || $cloneActionIsVisible || $deleteActionIsVisible || $isCollapsible || $visibleExtraItemActions): ?>
                            <div
...
<?php endif; ?>
<?php /**PATH C:\Users\johnk\Capstone-Project-II\Backend\vendor\filament\forms\resources\views\components\builder.blade.php ENDPATH**/ ?>